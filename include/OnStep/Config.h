...
//         DDT for Direct Drive Telescope 
...
#define BUZZER                       1200 //    OFF, ON, n. Where n=100..6000 (Hz freq.) for piezo speaker. ON for buzzer.    Option
...
#define WEATHER                    BME280 //    OFF, BME280 (I2C 0x77,) BME280_0x76, BME280_SPI, DHT_11_12 (see pinmap for CS.) Option
//#define DHT_DEVICE_PRESENT             
...
//         DHT (11 or 22) for temperature and pressure (see pinmap for DATA pin mapping DHT11_PIN)                      
...
#define GUIDE_TIME_LIMIT                5 //      0, No guide time limit. Or n. Where n=1..120 second time limit guard.       Adjust
...
#define SLEW_RATE_BASE_DESIRED         7  //    DDTscope uses a trapezoidal trajectory with .02 Turns/sec/360 deg or 7.2 deg/sec
                                          //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS1_STEPS_PER_DEGREE        400 //    DDScope has 45.5 encoder ticks/degree. How many steps/tick is smooth yet fast slew?
...
#define AXIS1_LIMIT_MIN              -181 //   -180, n. Where n= -90..-270 (degrees.) Minimum "Hour Angle" for Eq modes.      Adjust
//                                                   n. Where n=-180..-360 (degrees.) Minimum Azimuth for AltAzm mode.
#define AXIS1_LIMIT_MAX               181 //    180, n. Where n=  90.. 270 (degrees.) Maximum "Hour Angle" for Eq modes.      Adjust
...
// see https://onstep.groups.io/g/main/wiki/Configuration-Mount#AXIS2
                                          //    12800 n. Number of steps per degree:                                         <-Req'd
#define AXIS2_STEPS_PER_DEGREE        400 //    DDScope has 45.5 encoder ticks/degree. 
#define AXIS2_STEPS_PER_WORMROT         0 //    0, n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS4_SLEW_RATE_DESIRED        50 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr %   Adjust
...
#define AXIS4_DRIVER_DC_MODE           ON //    OFF, ON for pwm dc motor control on stepper driver outputs.                   Option
