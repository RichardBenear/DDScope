...
double cosLat                           = cos(latitude); //1.0;
double sinLat                           = sin(latitude); //0.0;
...
double currentAlt                       = 0.0;              // the current altitude
double currentDec                       = 0.0;               // the current declination
double AltitudeAxis                     = 0;
double AzimuthAxis                      = 0;
...
byte    lastParkStatus                  = parkStatus;
