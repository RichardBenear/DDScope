...
// Non-volatile storage ------------------------------------------------------------------------------
  ...
  #include "HAL/drivers/NV_I2C_EEPROM_AT24C32_PLUS.h"
#elif defined(NV_AT24C32)
  // defaults to 0x57 and 4KB
  #include "HAL/drivers/NV_I2C_EEPROM_24XX_C.h"
#elif defined(NV_MB85RC256V)
  #include "HAL/drivers/NV_I2C_FRAM_MB85RC256V.h"
#else
  #include "HAL/drivers/NV_EEPROM.h"
#endif
...
void HAL_Initialize(void) {
  ...
  CORE_PIN13_CONFIG = PORT_PCR_DSE | PORT_PCR_MUX(4); // SCK = 13 (PTC5)
